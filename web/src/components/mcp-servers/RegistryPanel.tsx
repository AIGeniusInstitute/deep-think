...
import { AddServerDialog } from '../mcp-registry/AddServerDialog';
import { ToolEditorDialog } from '../mcp-registry/ToolEditorDialog';
import { OpenApiImportDialog } from '../mcp-registry/OpenApiImportDialog';
import { TestToolDialog } from '../mcp-registry/TestToolDialog';
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="text-sm text-muted-foreground">
          共 {servers.length} 个服务分组 · Agent 通过 <code className="font-mono">__registry</code> MCP 挂载
        </div>
